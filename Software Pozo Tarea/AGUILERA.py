...
fig.patch.set_facecolor('#F0E68C')
ax.set_facecolor('#E0FFFF')
X1 = [Frecuencia_R_Acum[0],Frecuencia_R_Acum[2]]
X2 = [Frecuencia_R_Acum[3],Frecuencia_R_Acum[5]]
Y1 = [rango_graf[0],rango_graf[2]]
Y2 = [rango_graf[3],rango_graf[5]]
X = np.array(X1)
Xo = np.array(X2)
Y = np.array(Y1)
Yo = np.array(Y2)
...
x = [Frecuencia_R_Acum[0],Frecuencia_R_Acum[1],Frecuencia_R_Acum[2]]
y = [rango_graf[0],rango_graf[1],rango_graf[2]]
